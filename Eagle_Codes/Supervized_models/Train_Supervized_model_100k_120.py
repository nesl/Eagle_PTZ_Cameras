...
file_name_img = 'Path/images_120_100k.npz'
file_name_labels = 'Path/labels_120_100k.npz'

# checkpoint path to save
checkpoint_filepath = 'data/Train_Supervized_model_100k_120.h5'
filename='data/Train_Supervized_model_100k_120.csv'
...
model.fit(training_images, training_labels,
                    verbose=1,
                    epochs=epochs,
                    batch_size=256,callbacks=[model_checkpoint_callback, history_logger], validation_split = 0.2)
