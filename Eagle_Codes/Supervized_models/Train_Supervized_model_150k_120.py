...
file_name_img = 'path/images_120_150k.npz'
file_name_labels = 'path/labels_120_150k.npz'

# checkpoint path to save
checkpoint_filepath = 'data/Train_Supervized_model_150k_120.h5'
filename='data/Train_Supervized_model_150k_120.csv'
