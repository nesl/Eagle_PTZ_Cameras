...
training_image_size = 120

########Set the data path properly: Download the provided dataset
file_name_img = 'Path/images_120_50k.npz'
file_name_labels = 'Path/labels_120_50k.npz'


# checkpoint path to save
checkpoint_filepath = 'data/Train_Supervized_model_50k_120.h5'
filename='data/Train_Supervized_model_50k_120.csv'

###############################Set memory growth options#########
import tensorflow as tf
...
model.fit(training_images, training_labels,
                    verbose=1,
                    epochs=epochs,
                    batch_size=512,callbacks=[model_checkpoint_callback, history_logger], validation_split = 0.2)
