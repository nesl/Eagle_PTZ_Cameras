"""
Evaluate the custom supervized object detection models with Kalman and Controller
"""

#Episodes to test the models
no_of_episodes = 100


# Port where the simulator is running scene
global_port = 41451


#size of the input image for the models
image_size_to_use = 240


##############    Model path and test settings to use: Different models are available  ##################################

#test_setting = 'variable_background_trees_humans'
test_setting = 'fixed_background'

############################# 240*240 models ##########################
model_path = 'data/Train_Supervized_model_150k_240.h5'
#model_path = 'data/Train_Supervized_model_150k_240_2.h5'
#model_path = 'data/Train_Supervized_model_150k_240_3.h5'


#model_path = 'data/Train_Supervized_model_100k_240.h5'
#model_path = 'data/Train_Supervized_model_100k_240_2.h5'
#model_path = 'data/Train_Supervized_model_100k_240_3.h5'


#model_path = 'data/Train_Supervized_model_50k_240.h5'
#model_path = 'data/Train_Supervized_model_50k_240_2.h5'
#model_path = 'data/Train_Supervized_model_50k_240_3.h5'


############################# 120*120 models ##########################
#model_path = 'data/Train_Supervized_model_150k_120.h5'
#model_path = 'data/Train_Supervized_model_150k_120_2.h5'
#model_path = 'data/Train_Supervized_model_150k_120_3.h5'


#model_path = 'data/Train_Supervized_model_100k_120.h5'
#model_path = 'data/Train_Supervized_model_100k_120_2.h5'
#model_path = 'data/Train_Supervized_model_100k_120_3.h5'


#model_path = 'data/Train_Supervized_model_50k_120.h5'
#model_path = 'data/Train_Supervized_model_50k_120_2.h5'
#model_path = 'data/Train_Supervized_model_50k_120_3.h5'


save_name = model_path +'%'+test_setting +'%pickle'
print(save_name)

print(model_path)
print('port is:', global_port)
...
def get_model():
    i = Input(shape=(image_size_to_use, image_size_to_use, 1), name='input')
...
class PTZEnv(gym.Env):
    ...
    def get_bounding_box_engine(self):
        ...
        cars = self.curr_detections_engine #self.client_det.simGetDetections(camera_name=self.camera_name, image_type=0)
    ...
    def send_action(self,action):
        ...
        #print(self.fov, self.anglev, self.angleh)
...
def initialise_kalman(next_state):
    ...
    predict_box = model.predict(next_state, verbose=0)

    predict_box = predict_box[0]

    x1 = predict_box[0]*image_size_to_use
    x2 = predict_box[2]*image_size_to_use
    y1 = predict_box[1]*image_size_to_use
    y2 = predict_box[3]*image_size_to_use
...
def get_action_tuner(next_state, kf, env, tol_width, no_zoom, max_zoom_size):
    ...
    predict_box = model.predict(next_state, verbose=0)
    t2 = time.time()
    #print('Time to do inference:', t2-t1)
...
for i in range(no_of_episodes):
    ...
    while not done:
        ...
        #Mango tuned controller threshold parameters for 100 iterations (10 Episodes each)
        action = get_action_tuner(next_state,  kf, env, tol_width = 0.10, no_zoom = 0.20, max_zoom_size=0.39)

        #to make delay equal to the 30ms
