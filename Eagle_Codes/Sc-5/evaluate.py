...
checkpoint1 = 'Trained_sc5/sc5_model.zip'

The pickle structure is available in this file
Results are also visually displayed

During evaluation, we fix the sensing to actuation delay within 25 - 30ms at line: 587
...
# Replace with your checkpoint
#checkpoint1 = 'Trained_sc5/sc5_model.zip' : Pick this: 2000
#save_name = 'evaluation.pickle'

#checkpoint1 = 'lambda_sc5_1/best_model_color.zip': Pick this: 1995
#save_name = 'evaluation2.pickle'

#checkpoint1 = 'lambda_sc5_2/recent_model_color2000.zip'
#save_name = 'evaluation3.pickle'

#checkpoint1 = 'lambda_sc5_4/best_model_color.zip' #is not proper (1924, 0.32)
#checkpoint1 = 'lambda_sc5_4/recent_model_color2700.zip'
#save_name = 'evaluation4.pickle'

#checkpoint1 = 'lambda_sc5_4/recent_model_color2000.zip': Pick this: 1983
#save_name = 'evaluation5.pickle'

#checkpoint1 = 'lambda_sc5_4/recent_model_color2200.zip'
#save_name = 'evaluation6.pickle'

#checkpoint1 = 'lambda_sc5_2/recent_model_color1800.zip' # on 52
#save_name = 'evaluation7.pickle'

#checkpoint1 = 'lambda_sc5_2/recent_model_color1950.zip' # on 55
#save_name = 'evaluation8.pickle'

#checkpoint1 = 'lambda_sc5_2/recent_model_color1850.zip' # on 56
#save_name = 'evaluation9.pickle'
